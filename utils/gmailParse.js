...
const config = {
    user: 'hanna.kabachenko@scan.com',
    password: 'ocqd nbcu owsh azdp',
    host: 'imap.gmail.com',
    port: 993,
    tls: true,
...
async function main() {
    try {
        ...
        // const subject = 'Your MRI scan #NM4218 has been assigned to clinician Dr Hanna K';
        // const recipient = 'hanna.kabachenko@scan.com';
